...
if (isset($_POST['submit'])) {
    ...
    $create1 = "CREATE TABLE IF NOT EXISTS collab_req_details (sender_dept_id int,
        ...
        budget money, duration date ,content varchar(300),
    ...
    subject,budget, duration,content,req_status,receiver_dept_id,posted_on) VALUES ($a,'" . $_SESSION['department_name'] . "',
